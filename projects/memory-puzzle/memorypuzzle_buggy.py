...
BOARDWIDTH = 2#10 # number of columns of icons
...
def gameWonAnimation(board):
    # first addition
    victory_image_path = os.path.join(os.path.dirname("E:\Visual Studio Code\VSCODE PROGRAMS\/video-game-programming\projects\memory-puzzle\/victory.png"), 'victory.png')
    
    victory_image = pygame.image.load(victory_image_path)
    victory_rect = victory_image.get_rect()
    image_x = victory_rect.centerx
    image_y = 0
