...
# board needs to have an even number of boxes
...
# prevention for not having enough possible
# combinations to fill all the fields
...
# TODO: 2. change the direction the fields are revelaed/covered
...
# TODO: 1. draw squares around each field that change between yellow and green color every second on game win
# TODO: 3. on win, make little squares fall on the fields like confetti
    ...
    for i in range(13):
        ...
        for boxx in range(BOARDWIDTH):
            for boxy in range(BOARDHEIGHT):
                ...
                color = alternatingColors[colorIndex]
        ...
        colorIndex = (colorIndex + 1) % len(alternatingColors)
